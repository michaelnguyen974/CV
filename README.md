...
| [Event Planner](https://github.com/michaelnguyen974/new_event_plannerJS) |event planner app that allows you to make bookings and have it displayed onto the browser. It also incorporates a weather API that allows you to check the weather in a city to see if booking an event for that day is suitable! The app has been deployed on surge.| 5 days | Javascript | Custom testing framework |
